...
<div class="container">
    ...
    <div class="form-container">
        <form action="../../proses/simpan_pelanggan.php" method="post" id="costForm">
            <div class="form-grid">
...
<div class="loading-overlay" id="loadingOverlay">
    ...
    <script src="../../assets/js/material3-interactions.js"></script>
 <script>
document.addEventListener("DOMContentLoaded", () => {
    ...
    form.addEventListener('submit', function(e) {
        ...
        showToast('💾 Menyimpan data Pelanggan...', 'info');
    });
...
function validateForm() {
    ...
    const namapelanggan = formData.get('nama_pelanggan');
    if (!namapelanggan || namapelanggan.trim() === '') {
        showFieldError(form.querySelector('[name="nama_pelanggan"]'), 'Nama pelanggan wajib diisi');
        isValid = false;
    }
