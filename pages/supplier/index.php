...
// Set page title
$page_title = "Data Supplier - Stock Control Gudang";
                ...
                <?php if ($result->num_rows > 0): $no = 1; ?>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            <td><?= $no++; ?></td>
                            <td>
                                <strong><?= htmlspecialchars($row['nama_supplier']); ?></strong>
                            </td>
                            ...
                            <td>
                                <a href="edit.php?id=<?= $row['id_supplier']; ?>" class="action-btn action-btn-edit">
                                    ✏️ Edit
                                </a>
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    contactItems.forEach(item => {
        ...
        item.addEventListener('mouseenter', function() {
            this.style.backgroundColor = 'rgba(103, 80, 164, 0.1)';
