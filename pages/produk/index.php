...
// Set page title and paths for the design system
$page_title = "Data Produk - Stock Control Gudang";
                ...
                <?php if ($result->num_rows > 0): $no = 1; ?>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <a href="edit.php?id=<?= $row['id_produk']; ?>" class="action-btn action-btn-edit">
                                    ✏️ Edit
                                </a>
